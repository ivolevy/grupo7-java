...
public class AdminController {
    ...
    public ResponseEntity<ProductResponseDto> updateProduct(@PathVariable Long productId, @RequestBody ProductRequestDto productDetails) {
    ...
    public ResponseEntity<CategoryResponseDto> updateCategory(@PathVariable Long categoryId, @RequestBody CategoryRequestDto categoryDetails) {
    ...
    public ResponseEntity<DiscountResponseDto> createDiscount(@RequestBody DiscountRequestDto discountDto) {
        DiscountResponseDto newDiscount = discountService.createDiscount(discountDto);
        if (newDiscount == null) {
            return new ResponseEntity<>(HttpStatus.CONFLICT);
        }
    ...
    public ResponseEntity<DiscountResponseDto> updateDiscount(@PathVariable Long discountId, @RequestBody DiscountRequestDto discountDetails) {
        DiscountResponseDto updatedDiscount = discountService.updateDiscount(discountId, discountDetails);
